...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('libros', function (Blueprint $table) {
            ...
            $table->bigInteger('autorid')->unsigned(); // Crea una columna de tipo BIGINT sin signo para la clave externa de categoría.
            $table->string('Titulo'); // Crea una columna de tipo VARCHAR para el nombre del libro.
            ...
            $table->foreign('autorid')->references('id')->on('autores')->onDelete("cascade");
        });
    }
