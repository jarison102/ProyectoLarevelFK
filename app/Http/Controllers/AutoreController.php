...
class AutoreController extends Controller
{
    ...
    {
        $autore = new Autore();
        $autores = Autore::pluck('nombre', 'id'); // Obtén todos los autores
        return view('autore.create', compact('autore', 'autores')); // Pasa los autores a la vista
    }
    ...
    public function edit($id)
    {
        $autore = Autore::find($id);
        $autores = Autore::pluck('nombre', 'id'); // Obtén todos los autores
        return view('autore.edit', compact('autore', 'autores')); // Pasa los autores a la vista
    }
    /**
